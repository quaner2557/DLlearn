...
model.add(Convolution2D(128,(3,3),strides=(2,2),padding='valid',data_format='channels_first',input_shape = (1,64,64)))
...
print('Training ------------')
model.fit(X_train, y_train, batch_size=20,validation_split=0.2,epochs=250)
